...
De kernactiviteit van de start-up was een privacy-netwerk dat ze *Freedom* noemden. Freedom was gebaseerd op Wei Dai's PipeNet, het anonieme communicatieprotocol waarvan een bijgewerkte versie zou worden aangekondigd in dezelfde Cypherpunks-mailinglijstpost die b-geld introduceerde. Net als PipeNet, werden in Freedom's verhullingstechnieken een geavanceerdere variant van David Chaum's originele remailer-protocol ingebed, maar waar remailers alleen e-mails anonimiseerden, paste Freedom de mix-technologie toe om alle soorten internetgegevens te verhullen: e-mails, surfen, tekst-chat en meer.
