...
Om Alice een blinde handtekening te laten maken, zou Bob eerst een speciaal soort encryptiesleutel genereren, de zogenaamde *verblindende sleutel*, waarmee hij een bericht zou coderen (versleutelen). Bob zou het versleutelde bericht vervolgens aan Alice geven, die het met haar privésleutel cryptografisch zou ondertekenen. Wanneer ze het gecodeerde bericht ondertekent, weet ze niet wat het originele bericht eigenlijk is: ze *ondertekent blind*.
