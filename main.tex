...
\makeevenhead{mystyle}{\footnotesize\thepage}{{\scshape{\MakeUppercase\tiny Het Genesis Boek}}}{}
...
\par\noindent \textit{The Genesis Book}
...
mening dat de betaalverwerker een broedplaats was geworden voor
...
fraudedetectiesysteem had dan elke andere betaalverwerker die er
...
geen toegang heeft tot een creditcard of bankrekening.'\footnote{Huis
  ...
  Ninth Congress, Second Session, September 21,
  2006,~{[}https://www.govinfo.gov/content/pkg/CHRG-109hhrg31467/html/CHRG-109hhrg31467.htm.{]}}
...
nieuwe WAP-protocol.\footnote{\hspace{0pt}e-gold, `e-gold News',
  December 1999, geraadpleegd via
  {[}https://web.archive.org/web/20001209053900fw\ldots ttp://www.e-gold.com/news.html.{]}}
...
gereguleerd zou moeten worden.\footnote{\hspace{0pt}e-gold, `e-gold
  ...
  Currency', 20 januari 2006, geraadpleegd via
  {[}https://web.archive.org/web/20060304203618if\ldots ttp://www.e-gold.com:80/letter2.html.{]}}
...
boetes, besloot Jackson een schikking te treffen.\footnote{\hspace{0pt}US
  ...
  to Money Laundering and Illegal Money Transmitting Charges', July 21,
  2008,
...
intentie om illegale activiteiten te ondernemen er niet was'.\footnote{\hspace{0pt}e-gold
  ...
  United States District Judge', 114, November 20, 2008,
  \url{https://legalupdate.e-gold.com/2008/11/transcript-of-sentence-before-the-honorable-rosemarie-m-collyer-united-states-district-judge.html}}
...
verandering van zijn levenspad.\footnote{\hspace{0pt}Deirdre N.
  McCloskey, How to be Human\ldots\ldots ough an Economist, 33.} Hij
werd geboren in 1899 en groeide op tijdens de laatste jaren van het
...
afkomstig waren.\footnote{\hspace{0pt}Mises, Historical Setting, 3--19.}
...
\section{\texorpdfstring{`De cultuur van
hackers\footnote{Deze sectie is grotendeels gebaseerd op Steven Levy,
  Hackers: Heroes of the Computer Revolution.}'}{`De cultuur van hackers'}}\label{de-cultuur-van-hackers31}
...
fascisme vertegenwoordigden.\footnote{\hspace{0pt}Richard Stallman,
  `Talking to the Mailman', Interview by Rob Lucas, New Left Review,
  Sept--Oct 2018,
...
bespioneren of op een andere manier misbruiken.\footnote{\hspace{0pt}Angela
  ...
  Before', Wired, September 20, 2013,
...
verzamelen om ons te vergezellen in het delen.'\footnote{\hspace{0pt}GNU
  Operating System, `The GNU Manifesto',
...
paradijs dat we het internet noemen.' \footnote{\hspace{0pt}Raymond, The
...
Ludwig von Mises.\footnote{\hspace{0pt}Ludwig von Mises, The Theory of
  Money and Credit, trans. J.E. Batson.} De uitleg van Mises, het
...
Keynes,\footnote{\hspace{0pt}Nicholas Wapshott, Keynes Hayek: The Clash
  That Defined Modern Economics: 159.} verbood FDR in 1933 resoluut `het
hamsteren van gouden munten, goudstaaf en goudcertificaten binnen de
continentale Verenigde Staten'.\footnote{\hspace{0pt}Franklin D.
  Roosevelt, `Relating to the Hoarding, Export, and Earmarking of Gold
  Coin, Bullion, or Currency and to Transactions in Foreign Exchange',
  August 28, 1993, beschikbaar via The American Presidency Project.}
Alle Amerikaanse burgers werden bevolen elk goud dat ze hadden in te
ruilen voor dollars bij hun lokale Federale Reserve lidbank tegen het
vaste tarief van \$ 20.67. Bij niet-naleving stond een boete van \$
10.000 en een gevangenisstraf van maximaal tien jaar.
...
\footnote{Een groot deel van dit hoofdstuk is gebaseerd op Steven Levy's
...
democratie'.\footnote{Steven Levy, `E-Money', Wired, December 1, 1994,
...
een verkiezingsjaar'.\footnote{\hspace{0pt}Wapshott, Keynes Hayek, 242.}
...
beste belang van de Verenigde Staten' was. \footnote{\hspace{0pt}Richard
  ...
  Challenge of Peace'\,', August 15, 1971.} Zonder voorafgaande
...
het Bretton Woods-systeem effectief volledig verlaten.\footnote{\hspace{0pt}Michael
  J. Graetz and Olivia Briffault, `A 'Barbarous Relic': The French,
  Gold, and the Demise of Bretton Woods', in The Bretton Woods
  Agreements, eds.~Naomi Lamoreaux and Ian Shapiro: 121--142.}
...
naar dubbele cijfers.\footnote{Federal Reserve Economic Data, `Consumer
  Price Index for All Urban Consumers', beschikbaar via
...
overschrijden'.\footnote{\hspace{0pt}Hayek, Denationalisation of Money,
  91.}
...
elk geld dat ze geschikt achten konden uitgeven: ondersteund of niet
ondersteund, inflatoir of deflatoir, al dan niet in bestaan gebracht
...
dan welke instelling dan ook die dat zogenaamd nastreeft'.\footnote{\hspace{0pt}Hayek,
  The Argument Refined, 78.}
...
zo voordelig is voor de gebruiker als elk ander'.\footnote{\hspace{0pt}Hayek,
  The Argument Refined, 83.}
...
langzaam'.\footnote{\hspace{0pt}Hayek, The Argument Refined, 109.} Maar
uiteindelijk zouden mensen gaan begrijpen dat inflatoir fiatgeld continu
waarde verliest tegenover het privégeld. Ze zouden door economische
prikkels tot het inzicht komen dat wat ze echt van geld verwachten,
schaarste is.
...
gebruikers het meest acceptabel is'.\footnote{\hspace{0pt}Hayek, The
  Argument Refined, 77.}
...
weerleggen', schreef Hayek gefrustreerd.\footnote{\hspace{0pt}Hayek,The
  Argument Refined, 133.}
...
afwijzen ervan', schreef Hayek.\footnote{\hspace{0pt}Hayek, The Argument
  Refined, 93.}
...
we niet kunnen overzien'.\footnote{Hayek, The Argument Refined, 134.}
...
voorkomen.\footnote{Chaum zou later ook een oplossing voorstellen
  ...
  beperkt, aangezien de dader van een dubbele-uitgave aanval kan worden
  geïdentificeerd.}
...
digitale dollars ongeldig te verklaren.\footnote{Dat gezegd hebbende,
  zijn er nog enkele andere, mogelijk meer drastische maatregelen die
  Alice Bank had kunnen nemen. Naast het weigeren om digitale dollars
  aan Bob uit te geven, had ze ook alle elektronische contante
  betalingen kunnen blokkeren. Evenzo zou ze bepaalde gebruikers kunnen
  blokkeren van het accepteren van betalingen; zelfs als betalingen niet
  kunnen worden getraceerd, kunnen sommige gebruikers nog steeds worden
  uitgesloten van deelname aan het systeem.}
...
ontworpen.\footnote{Er kan worden gesteld dat Chaum een tamelijk losse
  ...
  tot persoon---een kenmerk dat fysiek contant geld wel heeft, omdat het
  vrij kan worden doorgegeven. Niettemin heeft Chaum een vorm van
...
uiteraard het overheidsproject voor tolheffing,\footnote{Uiteindelijk
  ...
  onder de naam `DyniCash' aan een in Dallas gevestigde onderneming die
...
hebt, je zult ervoor moeten betalen'.\footnote{Peter H. Lewis,
  `Attention Internet Shoppers: E-Cash Is Here', The New York Times,
  October 19, 1994,
...
Austria\footnote{DigiCash, `Bank Austria and Den norske Bank to Issue
  ecash™ the Electronic Cash for the Internet', DigiCash, April 14,
  1997, geraadpleegd via
...
bij de proeven. \footnote{Jeffrey Kutler, `Credit Suisse, Digicash in
  E-Commerce Test', American Banker, June 16, 1998,
...
een veteraan van Visa.\footnote{American Banker, `Digicash Sends Signal
  by Hiring Visa Veteran', American Banker, May 6, 1997,
...
Silicon Valley, waar de waarderingen van technologie-startups door het
...
leggen'.\footnote{Julie Pitta, `Requiem for a Bright Idea', Forbes,
  November 1, 1999,
...
herinnering zijn om vooruit te blijven gaan'.\footnote{Ed Regis, `Meet
  the Extropians', Wired, October 1, 1994,
...
daarbuiten'.\footnote{Douglas Martin, `Futurist Known as FM-2030 Is Dead
  at 69', The New York Times, July 11, 2000,
...
de jeugdige gezondheid herstellen'.\footnote{K. Eric Drexler, Engines of
  Creation, 146.}
...
waardesysteem'.\footnote{Max More, `Transhumanism: Towards a Futurist
  Philosophy', maxmore.com, geraadpleegd via
...
heelal te bewonen'.\footnote{Max More, `The Extropian Principles: A
  Transhumanist Declaration', maxmore.com, geraadpleegd via
...
hittegolven en reflectoren om zich te verbergen voor de buitenwereld. De
subtiele boodschap van het boek is dat Amerika's meest ijverige
ondernemers niet gedemoniseerd, maar gekoesterd en gevierd zouden moeten
worden.
...
illegale pornografie, stelde May voor.\footnote{Tim May, `Untraceable
  ...
  Freedom \& Privacy Conference , accessed via
...
uit: `Jullie zijn gewoon een stel cypherpunks!'\footnote{Tim May, `The
  Cyphernomicon', originally distributed through the Cypherpunks mailing
  list, September 10, 1994, available via
...
de behoeder van hun privacy gingen worden.\footnote{Hal Finney, `Chaum
  on the wrong foot?' originally sent to the Cypherpunks mailing list,
  August 22, 1993 available via
...
doen.'\footnote{Eric Hughes, `A Cypherpunk's Manifesto', originally sent
  to the Cypherpunks mailing list, March 17, 1993, available via
...
beschrijft.\footnote{Tim May, `Degrees of Freedom', originally sent to
  the Cypherpunks mailing list, February 8, 1996, available via
  {[}https://cypherpunks.venona.com/date/1996/02/msg00637.html.{]}} Of
misschien overschreed hij de sociaal aanvaardbare grenzen ronduit,
...
zeggen?), multinationale, informeel gebrek aan structuur.'\footnote{Tim
  May, `'Who shall speak for us?'\,', originally sent to the Cypherpunks
  mailing list, Available via
...
manifest'.\footnote{The title and text was a bit of a parody of Karl
  Marx's and Friedrich Engels's Communist Manifesto, while the term
  crypto-anarchy is something of a pun referring to crypto-fascism, the
  secret support for fascism.} Hij schreef het oorspronkelijk voor de
editie van de Crypto-conferentie in 1988, las het korte manifest voor
tijdens de allereerste bijeenkomst van de Cypherpunks in Hughes's
appartement en deelde het later ook via hun mailinglijst.
...
veranderen.'\footnote{Tim May, `The Crypto Anarchist Manifesto',
  originally sent to the Cypherpunks mailing list, November 22, 1992,
  available via
...
ondermijnen.'\footnote{Tim May, `Libertaria in Cyberspace', originally
  sent to the Cypherpunks mailing list, August 9, 1993, accessed via
...
doorbreken.'\footnote{Tim May, `Cyberspace, Crypto Anarchy, and Pushing
  Limits', originally sent to the Cypherpunks mailing list, April 3,
  1994, accessed via
  {[}https://cypherpunks.venona.com/date/1994/04/msg00096.html.{]}}
...
lichaamsdelen had gepiercet, en beter nog, een Netchick was.'\footnote{Tim
  May, `Hayek', originally sent to the Cypherpunks mailing list, August
  27, 1996, Accessed via
...
appartementen en hotelkamers!'\footnote{Tim May, `'Stopping Crime'
  Necessarily Means Invasiveness', originally sent to the Cypherpunks
  mailing list, October 17, 1996, accessed via:
...
snijden, zijn ze zo krachtig.'\footnote{Eric Hughes, `No digital coins',
  originally sent to the Cypherpunks mailing list, August 24, 1993,
  accessed via:
...
schreef May. \footnote{Tim May, `Crypto Activism and Respectability',
  originally sent to the Cypherpunks mailing list, April 21, 1993,
  accessed via:
...
wijdverspreid zijn zodat zo'n overheidsverbod zinloos wordt.'\footnote{Tim
  May, `Opportunities in Cyberspace', originally sent to the Cypherpunks
  mailing list, September 8, 1993, accessed via:
...
concurrenten.\footnote{Michelle Quinn, `The Cypherpunks Who Cracked
  Netscape', San Francisco Chronicle, September 20, 1995,
...
voorkeur in de gedrukte zin).'\footnote{Tim May, `Re: Stalling the
  crypto legislation for 2-3 more years', originally sent to the
  Cypherpunks mailing list, July 23, 1994, accessed via:
...
databanken.'\footnote{Tim May, `Scenario for a Ban on Cash
  Transactions', originally sent to the Cypherpunks mailing list,
  November 24, 1992, accessed via:
...
belastingopstand.'\footnote{Tim May, `Crypto Anarchy, the Government,
  and the National Information Infrastructure', originally sent to the
  Cypherpunks mailing list, November 29, 1993, accessed via:
...
May op de Cypherpunk mailinglijst.\footnote{Tim May, `DigiCash can use
  whatever currencies are valued', originally sent to the Cypherpunks
  mailing list, May 4, 1994, accessed via:
  {[}https://cypherpunks.venona.com/date/1994/05/msg00243.html.{]}} En:
`een van de potentiële voordelen van sterke encryptie is de vaak
besproken 'denationalisatie van geld.'\,'\footnote{Tim May, `Re:
  Hettinga's e€ yllogism', originally sent to the Cypherpunks mailing
  list, June 28, 1997, accessed via:
...
uitgavenrecords, etc., misbruikt zou worden.'\footnote{Tim May,
  `'Stopping Crime' Necessarily Means Invasiveness', originally sent to
  the Cypherpunks mailing list, October 17, 1996, accessed via:
...
fondsoverdrachtmethoden aan te bieden.'\footnote{Tim May, `Untraceable
  Payments, Extortion, and Other Bad Things', originally sent to the
  Cypherpunks mailing list, December 21, 1996, accessed via:
...
crypto-anarchisten en privacyfundamentalisten zou licenseren.\footnote{Douglas
  Barnes, `Re: cypherpunks digicash bank?', originally sent to the
  Cypherpunks mailing list, October 8, 1995, accessed via:
...
openbaren.'\footnote{Tim May, `Software Patents are Freezing Evolution
  of Products', originally sent to the Cypherpunks mailing list, October
  7, 1995, accessed via:
...
handtekeningen.\footnote{Hadon Nash, `Digital Gold', originally sent to
  the Cypherpunks mailing list, August 24, 1993, accessed via:
...
behoorlijk creatief is.'\footnote{Hal Finney, `Digital Gold, a bearer
  instrument?', originally sent to the Cypherpunks mailing list, August
  26, 1993, accessed via:
...
maatschappij.'\footnote{Black Unicorn, `DigiCash Announcement',
  originally sent to the Cypherpunks mailing list, May 10, 1994,
  accessed via:
...
`Jouw digitaal geld moet schaars zijn.'\footnote{Pr0duct Cypher, `Magic
  Money Digicash System', originally sent to the Cypherpunks mailing
  list, February 4, 1994, accessed via:
...
mensen besluiten een goed ruilmiddel te vinden.'\footnote{Perry E.
  Metzger, `Re: Virtual Cash', originally sent to the Cypherpunks
  mailing list, May 3, 1994, accessed via:
...
werkte.\footnote{Robert Hettinga, `Re: digital cc transactions, digital
  ...
  \url{https://cypherpunks.venona.com/date/1997/05/msg00147.html}} Als
een andere zeer actieve deelnemer in discussies over geld en
...
gegeven moment niet langer boekvermeldingen zijn.'\footnote{Robert
  Hettinga, `Re: Bypassing the Digicash Patents', originally sent to the
  Cypherpunks mailing list, April 29, 1997, accessed via:
...
grotere dwaas het geld zal aanvaarden.'\footnote{Tim May, `Re:
  alternative b-money creation', originally sent to the Cypherpunks
  mailing list, December 11, 1998, accessed via:
...
instanties.'\footnote{Tim May, `What backs up digital money?',
  originally sent to the Cypherpunks mailing list, March 27, 1996,
  accessed via:
...
mailinglijst in april 1997.\footnote{Adam Back, `Re: Bypassing the
  Digicash Patents', originally sent to the Cypherpunks mailing list,
  April 30, 1997, accessed via:
...
moeite doet om de banken erbij te betrekken.'\footnote{Adam Back,
  ...
  originally sent to the Cypherpunks mailing list, May 2, 1997, accessed
  via: {[}https://cypherpunks.venona.com/date/1997/05/msg00104.html.{]}}
...
overheidsbeleid.'\footnote{Adam Back, `Re: 'why privacy' revisited',
  originally sent to the Cypherpunks mailing list, March 22, 1997,
  available via:
...
toestaan om te bouwen.'\footnote{Adam Back, `The Bitcoin Game \#59:
  Dr.~Adam Back', interview by Rob Mitchell, The Bitcoin Game, YouTube,
  October 25, 2018,
...
Cypherpunk-mailinglijst in oktober 1995.\footnote{Adam Back, `Re:
  cypherpunks digicash bank?', originally sent to the Cypherpunks
  mailing list, October 8, 1995, accessed via:
...
cypherpunks?'\footnote{Adam Back, `cypherpunks digicash bank?',
  originally sent to the Cypherpunks mailing list, October 7, 1995,
  accessed via:
...
voortbestaan.'\footnote{Adam Back, `distributed virtual bank',
  originally sent to the Cypherpunks mailing list, August 27, 1997,
  accessed via:
...
waarschuwden Cypherpunks zoals Tim May.\footnote{Tim May, `Re: More on
  digital postage', originally sent to the Cypherpunks mailing list,
  February 15, 1997, accessed via:
...
voor de online privacy in het algemeen.\footnote{Adam Back, `Re: bulk
  postage fine', originally sent to the Cypherpunks mailing list, August
  3, 1997 accessed via:
...
overheidsinterventie, hartelijk dank.'\footnote{Adam Back, `no
  government regulation of the net', originally sent to the Cypherpunks
  mailing list, August 3, 1997, accessed via:
...
Junk Mail.'\footnote{Cynthia Dwork and Moni Naor, `Pricing via
  Processing or Combatting Junk Mail', Advances in Cryptology---Crypto
  '92 : 139--147.}.
...
Cypherpunk mailinglijst een bericht in hun inbox.\footnote{Adam Back,
  `ANNOUNCE hash cash postage implementation', originally sent to the
  Cypherpunks mailing list, March 28, 1997, accessed via:
  {[}https://cypherpunks.venona.com/date/1997/03/msg00774.html.{]}} Het
...
remailers.\footnote{Adam Back, `Re: Remailer problem solution?' March
  23, 1997, accessed via:
...
overheidsinmenging ingeplant.\footnote{Nick Szabo, `Why Cryptocurrency?
  ...
  interview by Zulu Republic, Zulu Republic, YouTube, October 25, 2018,
...
ervan.'\footnote{Nick Szabo, `Re: Crypto + Economics + AI = Digital
  Money Economies', originally sent to the Cypherpunks mailing list,
  September 19, 1995, accessed via:
...
computercodes.\footnote{Nick Szabo, `Smart Contracts: Building Blocks
  for Digital Free Markets', Extropy 16 : 50--64.}
...
hoofdpartijen als aanvallen van derden.' \footnote{Nick Szabo, `Re:
  Crypto + Economics + AI = Digital Money Economies', originally sent to
  the Cypherpunks mailing list, September 19, 1995, accessed via:
  {[}https://cypherpunks.venona.com/date/1995/09/msg01303.html.{]}}
...
verre Amsterdam?'\footnote{Nick Szabo, email to author, July 10, 2018.}
...
Parties are Security Holes' \footnote{Nick Szabo, `Trusted Third Parties
  are Security Holes', Satoshi Nakamoto Institute ,
  {[}https://nakamotoinstitute.org/trusted-third-parties/.{]}}, legde
Szabo later uit dat vertrouwde derde partijen vaak niet werden opgenomen
in de kosten van een ontwerp, en waarom hij geloofde dat dit een
vergissing was. Vertrouwde derde partijen zijn veiligheidsgaten,
...
allerbelangrijkste: de ontwerpen voor digitale valuta.\footnote{Nick
  Szabo, `Nick Szabo on Cypherpunks, Money and Bitcoin', interview by
  Peter McCormack, What Bitcoin Did, November 1, 2019,
...
hebben aangetoond, is dit geen ideale situatie.'\footnote{Nick Szabo,
  `Bit Gold', Unenumerated, December 27, 2008,
...
werk \emph{The Selfish Gene},\footnote{Richard Dawkins, The Selfish Gene
  , 244.} zou het vermogen om geld te gebruiken diep ingebed kunnen zijn
in het menselijk DNA en zou het de overleving van de soort ten voordele
gekomen kunnen zijn.

In zijn latere essay `Shelling Out: The Origins of Money',\footnote{Nick
  Szabo, `Shelling Out: The Origins of Money', Satoshi Nakamoto
  Institute , {[}https://nakamotoinstitute.org/shelling-out/.{]}} legt
Szabo uit hoe.
...
nummer', wat 150\footnote{It is worth noting however that this
  number---named after primatologist Robin Dunbar---has been criticized,
  and isn't, in the scientific community today, held with the
  specificity that it suggests. While there is a limit on the number of
  stable social relationships people can maintain, the actual number
  isn't necessarily 150 for everyone. See for instance Patrick
  Lindenfors, Andreas Wartel, and Johan Lind, `'Dunbar's Number'
  Deconstructed', Biology Letters, May 5, 2021:
...
\emph{gevangenendilemma}\footnote{Strictly speaking a `public goods
  game' is the more precise game theory analogy.} ontstaan.
...
het eerste gezicht willekeurige, reeks cijfers zijn.\footnote{In Szabo's
  original proposal, Bit Gold would actually use a `secure benchmark
  function', which is slightly different from a hash function, but
  similar enough that referring to the product as a `hash' and the act
  of producing it as `hashing' is accurate enough for the purpose of
  understanding Bit Gold's mechanics .}
...
publieke sleutels van hun eigenaren.\footnote{Nick Szabo, `Secure
  Property Titles with Owner Authority', Satoshi Nakamoto Institute ,
...
het `Sokpop probleem'.\footnote{Nick Szabo, `Nick Szabo --- The Quiet
  Master of Cryptocurrency \ldots{} Hosted by Naval Ravikant' interview
  by Tim Ferriss, The Tim Ferriss Show, YouTube, August 12, 2017,
...
inwisselbaar met die van de volgende periode'.\footnote{Nick Szabo, `Bit
  Gold Markets', Unenumerated, December 27, 2008,
...
in Vernor Vinge's roman `A Fire Upon the Deep'.\footnote{Wei Dai, `Work
  on Security Instead of Friendliness?' GreaterWrong, July 21, 2012,
...
de regering onmogelijk zal maken om te slagen.' \footnote{Wei Dai, `Law
  vs Technology', originally sent to the Cypherpunks mailing list,
  February 10, 1995, accessed via:
...
bekendmaakte.\footnote{Wei Dai, `PipeNet 1.1 and b-money', originally
  sent to the Cypherpunks mailing list, November 26, 1998, accessed via:
  {[}https://cypherpunks.venona.com/date/1998/11/msg00941.html.{]}} Het
gebeurde slechts weken nadat Szabo voor het eerst zijn digitale
...
ruilmiddel.'\footnote{Wei Dai, `Re: alternative b-money creation',
  originally sent to the Cypherpunks mailing list, December 11, 1998,
  accessed via:
...
erkende Dai later.\footnote{Wei Dai, comment in the discussion thread
  `AALWA: Ask any LessWronger anything', LessWrong, 2014,
...
noodzakelijk.'\footnote{Eric Hughes, `Kid Gloves or Megaphones',
  originally sent to the Cypherpunks mailing list, March 14, 1996,
  accessed via:
...
een 'gratis' Big Mac.'\footnote{Austin Hill, draft document from 2005
  shared with author, March 30, 2022.}'
...
niets revolutionairs te doen'\footnote{Damien Cave, `The Mojo solution',
  Salon, October 9, 2000,
  {[}https://www.salon.com/2000/10/09/mojo\_nation/.{]}} -- en samen met
...
zijn van de overheid. De startup zou een ambitieus open-source
...
speciale Mojo-handelsbeurs.\footnote{As a mildly interesting detail,
  most Mojo transactions were actually only recorded between two peers
  at first, each building up credit or debit with the other peer, to
  only settle the debt using an actual Mojo token when a certain
  threshold was met.}
...
grote PITA blijven.' \footnote{Daniel A. Nagy, comments in response to
  `The Mojo Nation Story---Part 2', Financial Cryptography, October 12,
  2005,
...
gebruikt,\footnote{Bryce Wilcox-O'Hearn, `Experiences Deploying A
  Large-Scale Emergent Network', Peer-to-Peer Systems : 104--110.}
bleken meerdere onderdelen van het systeem erg moeilijk om draaiende te
krijgen (en te houden). Met problemen variërend van netwerkinstabiliteit
tot ontbrekende bestandsfracties en een gebrek aan vertrouwen tussen
...
gebruikers,\footnote{Liang Wang, `BitTorrent Mainline DHT Measurement',
  MLDHT, 2013, accessed via:
  {[}https://www.cl.cam.ac.uk/\ldots525/MLDHT/.{]}} en in een typische
maand waren er wereldwijd zo'n 150 miljoen mensen verbonden met het
netwerk.\footnote{BitTorrent, `BitTorrent and µTorrent Software Surpass
  150 Million User Milestone; Announce New Consumer Electronics
...
was met de veranderingen).\footnote{Tim May, `My Departure, Moderation,
  and 'Ownership of the List', originally sent to the Cypherpunks
  mailing list, February 2, 1997, accessed via:
...
konden worden gehost door meerdere mensen tegelijk.\footnote{\hspace{0pt}Mark
  Frauenfelder, `Homeless Cypherpunks Turn to Usenet', Wired, February
  17, 1997,
...
verlies aan privacy zijn.'\footnote{Hal Finney, `Re: Physical to digital
  cash, and back again', originally sent to the Cypherpunks mailing
  list, August 19, 1993, accessed via:
...
beschermen, in plaats van hen te controleren.'\footnote{Hal Finney, `Why
  remailers\ldots{}', originally sent to the Cypherpunks mailing list,
  November 15, 1992, accessed via:
...
kan eten, zie ik de relevantie van cyberspace niet in.' \footnote{Hal
  Finney, `Re: Voluntary Governments?' originally sent to the
  Cypherpunks mailing list, August 4, 1994, accessed via:
...
inhaalt.'\footnote{Hal Finney, `POLI: Politics vs Technology',
  originally sent to the Cypherpunks mailing list, January 2, 1994,
  accessed via:
...
een bestaande bank daar?'\footnote{Hal Finney, `Re: Re: re: re: digital
  cash', originally sent to the Cypherpunks mailing list, March 16,
  1994, accessed via:
...
zouden meer lijken op papiergeld dan op bit-goud.'\footnote{Hal Finney,
  `RPOW Theory', RPOW website theory page, accessed via
...
representatie van computerrekenkracht.'\footnote{Hal Finney, `RPOW
  FAQs', RPOW website FAQ page, accessed via
...
houden.'\footnote{Gregory Maxwell, IRC message to author, August 13,
  2020.}
...
waarborgen.\footnote{Andrea Wong, `The Untold Story Behind Saudi
  Arabia's 41-Year U.S. Debt Secret', Bloomberg, May 31, 2016,
...
dan twee derde van de wereldreserves controleerden,\footnote{Energy
  ...
  Statistics and Analysis', Energy Exploration \& Exploitation, vol.~19,
  no. 2 \& 3 ,
...
de president een nieuwe Economische Beleidsadviesraad. Hierin benoemde
hij economen die een sterke voorkeur hadden voor de vrije markt,
waaronder opmerkelijk Milton Friedman, een vroege bewonderaar van
...
Staten. \footnote{Milton Friedman and Anna Schwartz, A Monetary History
  of the United States .} Hun studie bestreek de periode vanaf het
midden van de negentiende eeuw tot het midden van de twintigste eeuw,
met extra aandacht voor de Grote Depressie van de jaren 1930. Friedman
en Schwartz kwamen tot de conclusie dat elke economische recessie
voorafging aan een afname van de geldvoorraad, of op z'n minst een
...
inflatiecijfers wilden verlagen.\footnote{The Economist, `Why don't
  rising house prices count towards inflation?' The Economist, July 29,
  2021,
...
andere Europese landen genomen.\footnote{US Department of the Treasury,
  `Troubled Asset Relief Program', available via:
...
groep economen, bekend als de `Nieuwe Keynesianen'\footnote{New
  Keynesians integrated more of the neoclassical ideas on free markets,
  but also assumed more potential market failures, in particular due to
  an inability of some prices to adjust to new circumstances quickly,
  justifying government intervention. This most notably includes the
  price of labor due to psychological factors.}, drongen er bij
overheden wereldwijd op aan om het begrotingstekort te verhogen om zo
nationale economieën te stimuleren. Toen IMF-directeur Dominique
Strauss-Kahn in 2008 deze `Keynesiaanse heropleving' aanbeveelde,
stemden wereldleiders, onder wie de Amerikaanse president George W. Bush
en de Britse premier Gordon Brown, in met het steunen van de plannen.
Financiële stimuleringspakketten werden al snel over de hele wereld
uitgerold.
...
jouw ideeën uitbreidt tot een volledig functioneel systeem.'\footnote{Satoshi
  ...
  gwern.net, last modified September 14, 2017,
...
het onderwerp. \footnote{Satoshi Nakamoto, `Bitcoin P2P e-cash paper.'
  Originally sent to the Cryptography mailing list. October 31, 2008.
  Accessed via:
...
witboek.\footnote{Satoshi Nakamoto, `Bitcoin: A Peer-to-Peer Electronic
  Cash System' , available via: \url{https://bitcoin.org/bitcoin.pdf}}
...
het grootste deel uitmaken van wat een `blok' werd genoemd. Als twee of
meer conflicterende transacties in het netwerk circuleerden, kon slechts
een van hen in een blok worden opgenomen, en alleen transacties die in
een blok waren opgenomen zouden als bevestigd worden beschouwd.
...
\section{\texorpdfstring{\textbf{Delven}}{Delven}}\label{delven}
...
het delven zijn (of de `delvers') zouden willekeurig veel verschillende
nonces in een gewenst blok moeten proberen op te nemen, totdat één van
hen een geldige blokhash zou genereren. Een geldig blok --- dat door
niemand zou kunnen worden aangepast nadat het geproduceerd was, omdat
dat de blokhash ook zou veranderen --- zou dan over het netwerk worden
verzonden, waarbij elke gebruiker hun eigendomsregister zou bijwerken
met de transacties in dit blok.
...
alles weten, of een aanzienlijk deel daarvan.'\footnote{Joris A. Donald,
  `Bitcoin P2P e-cash paper', originally sent to the Cryptography
  mailing list, November 2, 2008, accessed via:
...
Nakamoto als antwoord op Donald in de mailinglijst. \footnote{Satoshi
  Nakamoto, `Bitcoin P2P e-cash paper', originally sent to the
  Cryptography mailing list, November 2, 2008, accessed via:
...
hebben gezien.' \footnote{Joris A. Donald, `Bitcoin P2P e-cash paper',
  originally sent to the Cryptography mailing list, November 3, 2008
  accessed via:
...
houden.'\footnote{Satoshi Nakamoto, `Bitcoin P2P e-cash paper',
  originally sent to the Cryptography mailing list, November 6, 2008,
  accessed via:
...
geval was geweest bij een systeem zoals RPOW.\footnote{Ray Dillinger,
  `Bitcoin P2P e-cash paper', originally sent to the Cryptography
  mailing list, November 6, 2008, Accessed via:
...
onderdeel was van Nakamotos ontwerp.\footnote{Ray Dillinger, `Bitcoin
  P2P e-cash paper', originally sent to the Cryptography mailing list,
  November 14, 2008, Accessed via:
...
minen, hoewel hij in zijn e-mail niet uitlegde waarom.\footnote{Joris A.
  Donald, `Bitcoin P2P e-cash paper', originally sent to the
  Cryptography mailing list, November 9, 2008, accessed via:
...
Honderd?'\footnote{Ray Dillinger, `Bitcoin P2P e-cash paper', originally
  sent to the Cryptography mailing list, November 15, 2008, accessed
  via:
...
is om vertakkingswedstrijden op te lossen.'\footnote{Joris A. Donald,
  `Bitcoin P2P e-cash paper', originally sent to the Cryptography
  mailing list, November 9, 2008, accessed via:
...
implementatie van dat concept zijn.'\footnote{Hal Finney, `Bitcoin P2P
  e-cash paper', originally sent to the Cryptography mailing list,
  November 7, 2008, accessed via:
...
besproken', schreef hij.\footnote{Hal Finney, `Bitcoin P2P e-cash
  paper', originally sent to the Cryptography mailing list, November 7,
  2008, accessed via:
...
concludeerde Finney. \footnote{Hal Finney, `Bitcoin P2P e-cash paper',
  originally sent to the Cryptography mailing list, November 13, 2008,
  accessed via:
...
echter beter met code dan met woorden.'\footnote{Satoshi Nakamoto,
  `Bitcoin P2P e-cash paper', originally sent to the Cryptography
  mailing list, November 14, 2008, accessed via:
...
detail opstelt en het publiceert.'\footnote{Perry E. Metzger, `ADMIN:
  end of bitcoin discussion for now', originally sent to the
  Cryptography mailing list, November 17, 2008, accessed via:
...
voor wat ik 'denationalisering van geld' heb genoemd.'\footnote{Friedrich
  ...
  Deficits, Inflation, and John Maynard Keynes', interview by Joris U.
  Blanchard III, re-uploaded by Libertarianism.org on April 19, 2015,
  {[}https://youtu.be/EYhEDxFwFRU.{]}}
\end{quote}
...
noodfinanciers.'\footnote{Hayek, interview.}
...
\chapter{De Codebasis}\label{de-codebasis}
...
e-mail deze keer.\footnote{Satoshi Nakamoto, `Bitcoin v0.1 released',
  originally sent to the Cryptography mailing list, January 8, 2009,
  Accessed via:
...
slordig'\footnote{Michael J. Casey, `Bitcoin Foundation's Andresen on
  Working With Satoshi Nakamoto', The Wall Street Journal, March 6,
  2014, {[}https://www.wsj.com/articles/BL-MBB-17626.{]}}, voor het
eerst volledig inzichtelijk hoe het elektronische grootboeksysteem
intern werkte.
...
blok later gedelfd moet zijn geweest na dat moment.\footnote{Since
  Bitcoin was ultimately released on January 8, this would have left the
  system's creator with a maximum of six days to comfortably generate
  coins in absence of any competition---but early block timestamps
  indicate that he didn't do this either.}
...
Eenentwintig miljoen munten.\footnote{It's worth noting though that each
  bitcoin can be divided up to eight decimal points, so in a way there
  are 2.1 quadrillion currency units. The smallest unit, 0.00000001
  bitcoin, is today usually referred to as a `satoshi', or `sat' for
  short.} Bitcoin was ontworpen met een vaste voorraad.
...
wordt in de wereld. Dan zou de totale waarde van de valuta gelijk moeten
...
één? Iets om over na te denken\ldots'\footnote{Hal Finney, `Bitcoin v0.1
  released', originally sent to the Cryptography mailing list, January
  10, 2009, accessed via:
...
prophecy}.'\footnote{Satoshi Nakamoto, `Bitcoin v0.1 released',
  originally sent to the Cryptography mailing list, January 16, 2009,
  accessed via:
  {[}https://www.metzdowd.com/pipermail/cryptography/2009-January/015014.html.{]}}
...
te garanderen.\footnote{This most famously included the 1-megabyte block
  size limit, preventing the block chain from growing so fast that most
  regular users wouldn't be able to run a Bitcoin node on their home
  computer.}
...
in hun eerste reacties op Nakamotos whitepaper.\footnote{The currently
  best-known example of such a payment layer is called the Lightning
  Network.}
